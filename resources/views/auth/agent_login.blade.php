...
<head>
    ...
    <title>iSwitch | Partner Command Center</title>
...
<body class="min-h-screen flex flex-col lg:flex-row overflow-x-hidden">
    ...
    <div class="lg:w-[40%] bg-slate-950 relative border-b lg:border-b-0 lg:border-r border-white/10 flex flex-col p-12 lg:p-20 overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col h-full">
            ...
            <div class="space-y-12">
                <div>
                    <span class="text-xs font-bold uppercase tracking-[0.3em] text-brand-emerald mb-4 block">B2B Partnership Program</span>
                    <h1 class="text-4xl lg:text-5xl font-black leading-tight mb-6 text-white">Scale Your Agency with iSwitch.</h1>
                    <p class="text-slate-400 text-lg lg:text-xl leading-relaxed">Login to the Command Center to access live inventory, manage your sub-agents, and track your global commissions in real-time.</p>
                </div>
                ...
                <div class="space-y-8">
                    <div class="flex gap-6 items-center">
                        ...
                        <div>
                            <h4 class="font-bold text-white text-lg">Tier-1 Commission</h4>
                            <p class="text-sm text-slate-500">Unbeatable rates for your agency volume.</p>
                        </div>
                    </div>
                    <div class="flex gap-6 items-center">
                        ...
                        <div>
                            <h4 class="font-bold text-white text-lg">Live Inventory API</h4>
                            <p class="text-sm text-slate-500">Real-time access to the Global Flight Vault.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-auto pt-20 border-t border-white/5">
                <p class="text-xs text-slate-500 font-medium uppercase tracking-widest">Enterprise B2B Credentials Required</p>
            </div>
        </div>
    </div>
    ...
    <div class="lg:w-[60%] flex items-center justify-center p-8 lg:p-24 relative">
        ...
        <div class="w-full max-w-md relative z-10">
            <div class="mb-12">
                <h2 class="text-3xl font-black mb-3 text-white">Partner Login</h2>
                <p class="text-slate-400">Enter your official agent credentials.</p>
            </div>

            <form action="#" class="space-y-6">
                <div>
                    <label class="block text-xs font-bold uppercase tracking-widest text-slate-500 mb-3 ml-1">Agency ID / Email</label>
                    <input type="text" placeholder="AG-9988-XXXX" class="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-brand-emerald/50 focus:bg-white/[0.07] transition-all placeholder:text-slate-600">
                </div>
                ...
                <button type="submit" class="w-full bg-brand-emerald text-white font-black py-4 rounded-2xl hover:bg-white hover:text-slate-950 transform active:scale-95 transition-all shadow-xl shadow-brand-emerald/10 group">
                    ...
                    <i class="fa-solid fa-shield-halved ml-2 group-hover:scale-110 transition-transform"></i>
                </button>
            </form>
