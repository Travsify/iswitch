    ...
    <nav x-data="{ mobileMenuOpen: false, scrolled: false }" 
        ...
        <div class="max-w-[90rem] mx-auto px-6 flex justify-between items-center">
            ...
            <a href="#" class="flex items-center gap-3 group relative z-50">
                <div class="w-10 h-10 bg-brand-orange rounded-xl flex items-center justify-center transform group-hover:rotate-12 transition-transform duration-300 shadow-[0_0_20px_rgba(255,125,0,0.4)]">
                    <i class="fa-solid fa-plane-departure text-white text-lg"></i>
                </div>
                <span class="text-2xl font-black tracking-tight text-white group-hover:text-brand-orange transition-colors">iSwitch</span>
            </a>
        ...
        <div class="max-w-[90rem] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-x-12 gap-y-16 mb-20 relative">
            ...
            <div class="lg:col-span-2">
                <a href="#" class="flex items-center gap-3 group relative z-50 mb-8 inline-flex">
                    <div class="w-10 h-10 bg-brand-orange rounded-xl flex items-center justify-center transform group-hover:rotate-12 transition-transform duration-300">
                        <i class="fa-solid fa-plane-departure text-white text-lg"></i>
                    </div>
